...
def args_parsing():
    ...
    parser.add_argument('--mean', type=float, default=1, help="The mean for filtering gene expression data.")
    ...
    parser.add_argument('--permutation_times', type=int, default=10000, help="Permutation times.")
