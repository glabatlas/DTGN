...
def args_parsing():
    ...
    parser.add_argument('--name', type=str, default="iPSC", help="Name of the model.")
    ...
    parser.add_argument('--encoder_layer', type=str, default="24,8,2", help="Structure of the encoder layers.")
    parser.add_argument('--decoder_layer', type=str, default="2,8,24", help="Structure of the decoder layers.")
